...
object OptionDemo2 extends App {
  ...
  println(s""" Value of os.name.get is ${ Option(System.getProperty("os.name")).mkString }""")
  ...
  println(s""" Value of os.name with default.get is ${ Option(System.getProperty("os.name")).orElse(Some("default")).mkString }""")
